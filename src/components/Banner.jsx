...
export default function Banner({ ruta, carpeta, click }) {
    ...
    function redirect(rute, db) {
        ...
        if (db.pdf && db.pdf !== undefined && db.redireccion && db.redireccion !== undefined && db.pdf === true) {
            window.open(db.redireccion, '_blank')
            return
        }
        if (db.modal && db.modal !== undefined && db.redireccion && db.redireccion !== undefined && db.modal === true) {
                                    ...
                                    ? <span onClick={() => click({ carpeta, i })}>
                                        {userDB[ruta][`${carpeta}`][i].url
                                            ...
                                            <>
                                                ...
                                                {(userDB[ruta][`${carpeta}`][i].enlace && userDB[ruta][`${carpeta}`][i].enlace.includes('https://www.youtube'))||(userDB[ruta][`${carpeta}`][i].enlace && userDB[ruta][`${carpeta}`][i].enlace.includes('drive.google.com'))
                                                    ? <iframe
