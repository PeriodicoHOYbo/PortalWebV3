...
function TemplateOne() {
  ...
  return (
    ...
    <div className='relative w-screen h-screen'>
      ...
      <img src={`${router.query.url.split('/o/')[0]}/o/${router.query.url.split('/o/')[1].replaceAll('/','%2F')}&token=${router.query.token}`} className='block relative w-screen h-screen object-contain' alt="" />
